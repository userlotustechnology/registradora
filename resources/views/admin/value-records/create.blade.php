...
<div class="card bg-white p-20 rounded-10 border border-white mb-4">
    ...
    <form action="{{ route('admin.value-records.store') }}" method="POST">
        @csrf
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                ...
                <select class="form-select @error('end_customer_id') is-invalid @enderror" 
                    ...
                    @foreach($endCustomers as $customer)
                        <option value="{{ $customer->id }}" data-partner="{{ $customer->partner_id }}" {{ old('end_customer_id') == $customer->id ? 'selected' : '' }}>
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="number" min="1" class="form-control @error('installments') is-invalid @enderror" 
                       id="installments" name="installments" value="{{ old('installments', 1) }}" required>
                @error('installments')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="alert alert-info" role="alert">
            ...
            O valor de cada parcela será calculado automaticamente dividindo o valor total pelo número de parcelas.
        </div>
